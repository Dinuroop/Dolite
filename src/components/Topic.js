...
const Topic = () => {
  return (
    ...
    <div style={{width: 27, height: 27, left: 110, top: 15, position: 'absolute'}}>
        <img style={{width: 21.38, height: 24.75}} src={T} className='Ticonimage' alt='Ticon'/>
        
    </div>
    <div className='blackIdea' style={{height: 26, marginLeft: 143, paddingTop: 10, color: 'black', fontSize: 24, fontFamily: 'Poppins', fontWeight: '500', wordWrap: 'break-word'}}>Topic</div>
    ...
    <div style={{width: 609, height: 39, left: 560, top: 10, position: 'absolute'}}>
        <div style={{height: 30, marginLeft: 39, marginTop: -5,color: 'rgba(15, 0, 180, 0.63)', fontSize: 32, fontFamily: 'Poppins', fontWeight: '500', wordWrap: 'break-word'}}>Topic</div>
        <div style={{width: 483, height: 13, marginLeft: 135, marginTop: -20, color: 'rgba(0, 0, 0, 0.59)', fontSize: 20, fontFamily: 'Poppins', fontWeight: '500', wordWrap: 'break-word'}}>Select the topic on which you want to write the article</div>
