...
const Topic = () => {
  return (
    ...
    <div style={{width: 4, height: 43, left: 100, top: 7, position: 'absolute', background: 'linear-gradient(177deg, #0400C6 0%, #480253 100%)', borderRadius: 2.50}} />
    <div style={{width: 27, height: 27, left: 115, top: 15, position: 'absolute'}}>
        <img style={{width: 21.38, height: 24.75}} src={T} className='Ticonimage' alt='Ticon'/>
        
    </div>
    <div style={{width: 4, height: 43, left: 146, top: 7, position: 'absolute', background: 'linear-gradient(177deg, #0400C6 0%, #480253 100%)', borderRadius: 2.50}} />
    <div style={{width: 35, height: 35, left: 166, top: 11, position: 'absolute'}}>
        <img style={{width: 35, height: 35}} src={blogIcon} className='Blogimage' alt='BlogIcon'/>
    </div>
    <div className='blackIdea' style={{height: 26, marginLeft: 210, paddingTop: 10, color: 'black', fontSize: 24, fontFamily: 'Poppins', fontWeight: '500', wordWrap: 'break-word'}}>Blog</div>
    <div style={{height: 39, left: 560, top: 10, position: 'absolute'}}>
        <div style={{height: 30, marginLeft: 39, marginTop: -5,color: 'rgba(15, 0, 180, 0.63)', fontSize: 32, fontFamily: 'Poppins', fontWeight: '500', wordWrap: 'break-word'}}>Blog</div>
        <div style={{marginLeft: 135, marginTop: -20, color: 'rgba(0, 0, 0, 0.59)', fontSize: 20, fontFamily: 'Poppins', fontWeight: '500'}}>Conform and enter your blog is ready on no time</div>
